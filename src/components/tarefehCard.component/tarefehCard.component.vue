<template lang="">
    <div @click.stop.prevent="handleCheck(tarefehInfo.price)" :class="{'border-gray-200':!checked,'border-cyan-500':checked,'h-auto':!toggled,'max-h-fit':toggled}" class="bg-gray-100 cursor-pointer h-fit p-3 md:p-5 border-2 flex-grow   rounded-lg transition-all sm:m-2 mx-0 my-2">
